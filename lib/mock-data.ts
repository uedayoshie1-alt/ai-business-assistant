...
export const mockReceipts: Receipt[] = [
  ...
  },
  {
    ...
    reason: '飲食店での支出。「打合せ」「顧客」キーワードから会議費を提案。5,000円以下のため接待交際費より会議費が妥当。',
  ...
  {
    id: 'r004', date: '2026-04-22', amount: 2750,
    vendor: 'アマゾンジャパン合同会社', purpose: '事務用品購入',
    accountCategory: '消耗品費', accountCategorySuggestions: ['消耗品費', '事務用品費'],
    reason: 'ECサイト経由の購入。「事務用品」キーワードから消耗品費を提案。',
    taxRate: 10, status: 'pending', sourceType: 'image', extractedAt: '2026-04-26T09:18:00',
  },
  {
    id: 'r005', date: '2026-04-20', amount: 15400,
    vendor: '東京電力エナジーパートナー', purpose: '事務所電気代 4月分',
    accountCategory: '水道光熱費', accountCategorySuggestions: ['水道光熱費'],
    reason: '電力会社への支払い。「電気代」キーワードから水道光熱費を提案。',
    taxRate: 10, status: 'confirmed', sourceType: 'image', extractedAt: '2026-04-21T08:30:00',
  },
  {
    id: 'r006', date: '2026-04-18', amount: 12100,
    vendor: 'レストラン銀座 松', purpose: '顧問先との会食',
    accountCategory: '接待交際費', accountCategorySuggestions: ['接待交際費', '会議費'],
    reason: 'レストランでの高額支出。「顧問先」「会食」キーワードから接待交際費を提案。5,000円超のため接待交際費が妥当。',
    taxRate: 10, status: 'confirmed', sourceType: 'image', extractedAt: '2026-04-19T10:00:00',
  },
  {
    id: 'r007', date: '2026-04-17', amount: 4500,
    vendor: 'ビジネス書店 丸善 丸の内本店', purpose: '専門書籍購入（労務管理）',
    accountCategory: '図書費', accountCategorySuggestions: ['図書費', '消耗品費'],
    reason: '書店での支出。「専門書籍」「労務管理」キーワードから図書費を提案。',
    taxRate: 10, status: 'confirmed', sourceType: 'image', extractedAt: '2026-04-17T17:30:00',
  },
  {
    id: 'r008', date: '2026-04-15', amount: 980,
    vendor: 'NTTドコモ', purpose: '携帯電話料金 3月分',
    accountCategory: '通信費', accountCategorySuggestions: ['通信費'],
    reason: '通信事業者への支払い。「携帯電話料金」キーワードから通信費を提案。',
    taxRate: 10, status: 'rejected', sourceType: 'video', extractedAt: '2026-04-16T08:00:00',
  },
  {
    id: 'r009', date: '2026-04-12', amount: 6600,
    vendor: '日本橋 和食 さくら', purpose: '新入社員歓迎会',
    accountCategory: '福利厚生費', accountCategorySuggestions: ['福利厚生費', '接待交際費'],
    reason: '飲食店での支出。「歓迎会」キーワードから福利厚生費を提案。社内行事のため接待交際費より福利厚生費が妥当。',
    taxRate: 10, status: 'confirmed', sourceType: 'image', extractedAt: '2026-04-13T09:00:00',
  },
  {
    id: 'r010', date: '2026-04-10', amount: 330,
    vendor: 'ファミリーマート 渋谷桜丘店', purpose: '打合せ飲料',
    accountCategory: '会議費', accountCategorySuggestions: ['会議費', '消耗品費'],
    reason: 'コンビニエンスストアでの少額支出。「打合せ飲料」キーワードから会議費を提案。',
    taxRate: 8, status: 'pending', sourceType: 'video', extractedAt: '2026-04-11T08:00:00',
  },
]
